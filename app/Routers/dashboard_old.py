...
from Backend.app.Utils.database_handler_old import DatabaseHandler
from app.Utils.chatgpt import get_last_message
from Backend.app.Utils.regular_update_old import job
from app.Utils.regular_send import send
from app.Utils.Auth import get_current_user
from app.Model.Settings import SettingsModel
from Backend.app.Utils.regular_update_old import update_notification
from Backend.app.Utils.regular_update_old import job
...
def set_variables(variables: SettingsModel):
    ...
    if data == None:
        ...
        print('here2')
        print(variables.prompts)
        variables.openAIKey = variables.openAIKey or data[1]
        print(variables.prompts)
        variables.twilioPhoneNumber = variables.twilioPhoneNumber or data[2]
        variables.twilioAccountSID = variables.twilioAccountSID or data[3]
        variables.twilioAuthToken = variables.twilioAuthToken or data[4]
        variables.sendgridEmail = variables.sendgridEmail or data[5]
        variables.sendgridApiKey = variables.sendgridApiKey or data[6]
        variables.prompts = variables.prompts or data[7]
        db.update_variables(variables, data[0])
    return True

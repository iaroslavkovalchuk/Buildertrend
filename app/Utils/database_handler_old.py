...
class DatabaseHandler:
    ...
    def insert_customer(self, first_name="", last_name="", email="", phone="", address=""):
        ...
        val_check = (first_name, last_name)
        self.execute_query(sql_check, val_check)
        result = self.cursor.fetchone()
        print("customer_id: ", result)
    ...
    def update_variables(self, variables: SettingsModel, id):
        sql = "UPDATE tbl_variables SET openAIKey = %s, twilioPhoneNumber = %s, twilioAccountSID = %s, twilioAuthToken = %s, sendgridEmail = %s, sendgridApiKey = %s, prompts = %s WHERE id = %s"
        val = (variables.openAIKey, variables.twilioPhoneNumber, variables.twilioAccountSID, variables.twilioAuthToken, variables.sendgridEmail, variables.sendgridApiKey, variables.prompts, id)
        self.execute_query(sql, val)
        self.db.commit()
